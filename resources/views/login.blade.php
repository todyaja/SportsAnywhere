                ...
                <div class="form-box w-100 p-4 d-flex flex-column justify-content-center rounded">
                    ...
                    <form action="{{url('loginprocess')}}" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control form-control-sm" placeholder="Email" id="floatingInput" name="email">
                    ...
                    <div class="mt-3 d-flex justify-content-center">
                        ...
                        <a href="/register"><button class="p-0 border-0 bg-transparent text-decoration-underline" style="color: blue">Sign Up</button></a>
                    </div>
