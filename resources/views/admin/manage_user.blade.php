            ...
            <div class="card-body">
                <div class="d-flex w-100 flex-row m-auto">
                    <div class="d-flex align-items-center justify-content-center">
                        <img src="{{ asset('assets/profile_pictures/' . $d->profile_picture) }}"
                            style="width: 150px; height: 150px" class="card-img-top" alt="...">
                    </div>
                    <div class="d-flex flex-column w-100 px-5 d-flex align-items-start">
                        <h2 class="">{{ $d->email }}</h2>
                        <div class="d-flex flex-column w-100 d-flex mt-2 align-items-start">
                            <p>{{ $d->username }}</p>
                        ...
                        <div class="modal-content">
                            <form action="{{ url('user/' . $d->id) }}" method="POST">
                                ...
                                <div class="modal-header border-0">
                                    <h5 class="text-secondary modal-title" id="exampleModalLabel">Delete User</h5>
                                ...
                                <div
                                    ...
                                    <h6 class="text-center my-2 text-secondary">Do you want to delete
                                        <b>{{ $d->username }}</b>? This process cannot
                                        be undone.
                                    </h6>
                                </div>
